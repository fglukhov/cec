...
$(document).ready(function() {
	...
	$(".service-tmb").on("click", function () {


		if (!$(this).hasClass("active")) {

			$(".service-tmb").not($(this)).addClass("collapsed");

			$(".service-tmb.active").removeClass("active");
			...
			if ($("#md-indicator").css("display") == "block") {
				...
				$(".service-tmb").css({
					maxHeight: $(this).prop("init-height")
				});

				$(this).css({
					maxHeight: $(this).find(".service-tmb-content").outerHeight()
				});
		...
		if (!$(this).closest(".room-descr").length) {
			...
			$.ajax({
				...
				curModal.on("shown.bs.modal", function () {
					...
					curModal.find(".slick-slider").slick("setPosition");
	...
	$("body").on("click", function(e) {
		if ($("#mobile-indicator").css("display") == "block" && !$(e.target).hasClass("navbar-wrapper") && !$(e.target).parents().hasClass("navbar-wrapper") && !$(e.target).hasClass("navbar-trigger") && !$(e.target).parents().hasClass("navbar-trigger")) {
	...
	$("body").on("click", ".expandable-trigger", function() {
		...
		if (!exTrigger.hasClass("active")) {
			exTrigger.closest(".expandable").find(".expandable-content").slideDown(500, function() {
				...
				exTrigger.html(exTrigger.data("collapsetext"));
			...
			exTrigger.closest(".expandable").find(".expandable-content").slideUp(500, function() {
				...
				exTrigger.html(exTrigger.data("expandtext"));
...
function initSliders() {
	...
	$(".dates-slider").each(function () {

		$(this).on("afterChange", function(event, slick, currentSlide) {

			if ($(this).find(".slick-prev").hasClass("slick-disabled")) {

				$(this).closest(".dates-slider-over-wrapper").find(".dates-slider-prev").addClass("slick-disabled");

			} else {

				$(this).closest(".dates-slider-over-wrapper").find(".dates-slider-prev").removeClass("slick-disabled");
				
			}

			if ($(this).find(".slick-next").hasClass("slick-disabled")) {

				$(this).closest(".dates-slider-over-wrapper").find(".dates-slider-next").addClass("slick-disabled");

			} else {

				$(this).closest(".dates-slider-over-wrapper").find(".dates-slider-next").removeClass("slick-disabled");
		...
		$(".dates-slider").on("init", function () {

			var datesSlider = $(this);

			console.log($(this).find(".slick-prev").hasClass("slick-disabled"));
			...
			$(this).closest(".dates-slider-over-wrapper").find(".dates-slider-prev").click(function () {

				datesSlider.slick("slickPrev");

			});

			$(this).closest(".dates-slider-over-wrapper").find(".dates-slider-next").click(function () {

				datesSlider.slick("slickNext");
	...
	$(".hist-pic-slider, .project-pic-slider, .project-item-slider").each(function () {
...
function  makeUp() {
	...
	if ($("#md-indicator").css("display") == "block" && $("#sm-indicator").css("display") != "block"  && $("#mobile-indicator").css("display") != "block") {
	...
	$(".service-tmb").prop("init-height", servHeight);
